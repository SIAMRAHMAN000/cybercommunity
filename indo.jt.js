var drvee = (function() {
    ...
    var plane = new JetPlane(resources.jet_img, plane_x, plane_y, color, formation_x, formation_y, "s14m_69");
    ...
    // Update colors according to the new requirements
    formation.addPlane(0, -0, "0, 255, 0");      // Left 1: Green
    formation.addPlane(15, -25, "0, 255, 0");     // Left 2: Green
    formation.addPlane(30, -50, "255, 0, 0");     // Middle 1: Red
    formation.addPlane(45, -50, "255, 0, 0");     // Middle 2: Red
    formation.addPlane(60, -25, "0, 255, 0");     // Right 1: Green
    formation.addPlane(75, 0, "0, 255, 0");       // Right 2: Green
    ...
    var JetPlane = function(img, initX, initY, smoke_rgb, formation_x, formation_y, name) {
    this.img = img;
    this.x = initX;
    this.y = initY;
